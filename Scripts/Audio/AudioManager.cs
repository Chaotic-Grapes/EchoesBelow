...
=======
    private const float DamageBusLowPassGain = 0.093f;
    // how long the damage muffle stays active
...
=======
        EngineAudio.ClearBusLowPassFilter(EngineAudioBus.SFX);
>>>>>>> Stashed changes
...
=======
        if (Input.IsKeyPressed(KeyCode.P))
        {
            ...
            _damageLowPassTimer = 0.0f;
            _damageLowPassDurationActive = 0.0f;
            EngineAudio.SetBusLowPassFilter(EngineAudioBus.SFX, debugGain);
            Log(_debugBusLowPassForced ? "debug sfx bus lpf on" : "debug sfx bus lpf off");
        }
>>>>>>> Stashed changes
        ...
        if (_damageLowPassTimer > 0.0f)
        {
            ...
            if (_damageLowPassDurationActive > 0.0f)
            {
                ...
                EngineAudio.SetBusLowPassFilter(EngineAudioBus.SFX, gain);
            }
...
=======
                _damageLowPassDurationActive = 0.0f;
                EngineAudio.SetBusLowPassFilter(EngineAudioBus.SFX, DefaultBusLowPassGain);
>>>>>>> Stashed changes
            }
        }
